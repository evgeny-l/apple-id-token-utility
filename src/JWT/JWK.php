...
namespace EvgenyL\AppleIdTokenUtility\JWT;

use Firebase\JWT\JWT;
use UnexpectedValueException;

/**
 * Library class copied from the original library https://github.com/fproject/php-jwt
 * @license https://github.com/fproject/php-jwt/blob/master/LICENSE
 * @license http://opensource.org/licenses/BSD-3-Clause 3-clause BSD
 *
 * Made to avoid namespace/implementation conflicts with fork-source library firebase/php-jwt.
 */
